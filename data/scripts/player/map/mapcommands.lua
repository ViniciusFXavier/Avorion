...
function MapCommands.updateJumpRangeArea()
    ...
    map:setJumpRangeArea(ivec2(x, y), reach, canPassRifts, true)
end
...
function MapCommands.onPortraitRightClicked(pressedPortrait)
    ...
    function MapCommands.onSwitchToCraftClicked()
        player:sendChatMessage(string.format("/teleporttoship %i %i %i \"%s\"", craftPortrait.coordinates.x, craftPortrait.coordinates.y, craftPortrait.owner, craftPortrait.name), 1)
    end

    function MapCommands.onSwitchToSectorClicked()
        player:sendChatMessage(string.format("/teleporttoship %i %i", craftPortrait.coordinates.x, craftPortrait.coordinates.y), 1)
    end
end
